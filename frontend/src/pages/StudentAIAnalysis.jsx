...
export default function StudentAIAnalysis() {
  ...
  if (!analysis) return <div className="editorial p-8 text-ink-500">AI analysis is not available for this student yet.</div>;
    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-12 gap-3">
        <div className="col-span-12 lg:col-span-5 editorial bg-ink-900 text-bone-100 p-8">
          ...
          <div className="font-serif text-bone-100/70 mt-2">
            Predicted package band: {analysis.prediction?.expected_package_lpa || 0} LPA. Risk: {analysis.prediction?.risk_level || "unknown"}.
          </div>
        </div>
      ...
      <div className="grid grid-cols-12 gap-3">
        <div className="col-span-12 md:col-span-6 editorial p-8">
          ...
          <div className="space-y-3">
            {(analysis.weak_dsa_topics || []).map((topic) => (
        ...
        <div className="col-span-12 md:col-span-6 editorial p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="border border-line bg-bone-50 p-5">
              ...
              <div className="font-display text-4xl text-accent mt-2 tnum">{analysis.prediction?.probability || 0}%</div>
            </div>
            <div className="border border-line bg-bone-50 p-5">
          ...
          <div className="mt-5 flex items-center gap-2 text-sm text-ink-600">
            ...
            Recommended skills: {(analysis.prediction?.recommended_skills || []).join(", ") || "Keep building core skills"}
          </div>
        </div>
      </div>
    </div>
